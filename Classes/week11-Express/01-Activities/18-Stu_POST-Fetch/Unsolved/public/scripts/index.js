...
// Answer: Takes a review object and sends a post
const postReview = (review) =>
  ...
  // Answer: Grabs all reviws and shows the headers
  fetch('/api/reviews', {
    method: 'POST',
    headers: {
	...
	// Answer: Catches any error that comes up and sends the error to the console.
    .catch((error) => {
